            ...
            <div class="container height-100vh">
                ...
                <div class="absolute-middle-center width-55 sm-width-90 padding-four-all xs-padding-eight-tb">
                    ...
                    <div class="row margin-eight-bottom">
                        <div class="col-12">
                            <img src="<c:url value='/resources/img/logos/logo-white.png'/>" alt="" class="sm-width-250px xs-width-150px" />
                        </div>
                    </div>
                    ...
                    <div class="row page-container">
                        <div class="col-12">
                            ...
                            <a href="<c:url value='/' />" class="butn margin-10px-right margin-10px-bottom">Back to Home</a>
                            <a href="<c:url value='/contact'/>" class="butn margin-10px-bottom">Contact Us</a>
                        </div>
                    </div>

                    <div class="row margin-50px-top sm-margin-25px-top">
                        <div class="col-12">
                            &copy; 2019 Amava <a href="#" class="text-white">Privacy Policy</a>
                        </div>
                    </div>
