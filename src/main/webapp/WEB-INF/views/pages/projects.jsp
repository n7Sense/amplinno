                ...
                <div class="row">
                    ...
                    <div class="gallery text-center width-100">
                        ...
                        <div class="col-md-4 items design">
                            <div class="item-img">
                                <img src="<c:url value='/resources/img/portfolio/1.jpg'/>" alt="image">
                                <div class="item-img-overlay valign">
                                    <div class="overlay-info width-100 vertical-center">
                                        <h6>Clock mockup</h6>
                                        <p>Work description here</p>
                                        <a href="<c:url value='/resources/img/portfolio/1.jpg'/>" class="popimg">
                        ...
                        <div class="col-md-8 items design">
                            <div class="item-img">
                                <img src="<c:url value='/resources/img/portfolio/2.jpg'/>" alt="image">
                                <div class="item-img-overlay valign">
                                    <div class="overlay-info width-100 vertical-center">
                                        <h6>Label Design</h6>
                                        <p>Work description here</p>
                                        <a href="<c:url value='/resources/img/portfolio/2.jpg'/>" class="popimg">
                                            <i class="fa fa-search-plus"></i>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4 items develop">
                            <div class="item-img">
                                <img src="<c:url value='/resources/img/portfolio/3.jpg'/>" alt="image">
                                <div class="item-img-overlay valign">
                                    <div class="overlay-info width-100 vertical-center">
                                        <h6>Cup Design Mockup</h6>
                                        <p>Work description here</p>
                                        <a href="<c:url value='/resources/img/portfolio/3.jpg'/>" class="popimg">
                                            <i class="fa fa-search-plus"></i>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4 items graphic">
                            <div class="item-img">
                                <img src="<c:url value='/resources/img/portfolio/4.jpg'/>" alt="image">
                                <div class="item-img-overlay valign">
                                    <div class="overlay-info width-100 vertical-center">
                                        <h6>Macaron Mockup </h6>
                                        <p>Work description here</p>
                                        <a href="<c:url value='/resources/img/portfolio/4.jpg'/>" class="popimg">
                                            <i class="fa fa-search-plus"></i>
                                        </a>
                                    </div>
                        ...
                        <div class="col-md-4 items graphic">
                            <div class="item-img">
                                <img src="<c:url value='/resources/img/portfolio/5.jpg'/>" alt="image">
                                <div class="item-img-overlay valign">
                                    <div class="overlay-info width-100 vertical-center">
                                        <h6>Coffee Cup Design</h6>
                                        <p>Work description here</p>
                                        <a href="<c:url value='/resources/img/portfolio/5.jpg'/>" class="popimg">
                                            <i class="fa fa-search-plus"></i>
                                        </a>
                                    </div>
                        ...
                        <div class="col-md-8 items develop">
                            <div class="item-img">
                                <img src="<c:url value='/resources/img/portfolio/6.jpg'/>" alt="image">
                                <div class="item-img-overlay valign">
                                    <div class="overlay-info width-100 vertical-center">
                                        <h6>Creative Design</h6>
                                        <p>Work description here</p>
                                        <a href="<c:url value='/resources/img/portfolio/6.jpg'/>" class="popimg">
                                            <i class="fa fa-search-plus"></i>
                                        </a>
                                    </div>
                        ...
                        <div class="col-md-4 items">
                            <div class="item-img">
                                <img src="<c:url value='/resources/img/portfolio/7.jpg'/>" alt="image">
                                <div class="item-img-overlay valign">
                                    <div class="overlay-info width-100 vertical-center">
                                        <h6>Book Mockup</h6>
                                        <p>Work description here</p>
                                        <a href="<c:url value='/resources/img/portfolio/7.jpg'/>" class="popimg">
                                            <i class="fa fa-search-plus"></i>
                                        </a>
                                    </div>
