        ...
        <div class="container">
            <div class="row">
                <div class="col-12 wow fadeIn">
                    ...
                    <form method="post" action="/login" class="mailform off2" >
                        <div class="row">
                            <div class="col-md-2">
                                <label>User Name</label>
                            </div>
                            <div class="col-md-4">
                                <input type="text" id="userName" name="userName" placeholder="User Name:" data-constraints="@LettersOnly @NotEmpty">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <input type="password" name="password" id="password" placeholder="Password:" data-constraints="@LettersOnly @NotEmpty">
                            </div>
                        </div>
